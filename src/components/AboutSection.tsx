  ...
  return (
    <section id="about" className="py-20 md:py-28 section-alt">
      <div className="container max-w-4xl" ref={ref}>
        ...
        <div className={`mt-8 space-y-5 text-muted-foreground leading-relaxed text-pretty ${isVisible ? "animate-reveal-up delay-200" : "opacity-0"}`}>
          <p>
        ...
        <div className={`mt-12 grid grid-cols-2 md:grid-cols-4 gap-8 ${isVisible ? "animate-reveal-up delay-400" : "opacity-0"}`}>
          {stats.map((s) => (
